...
Now we need to create the MCP user on the contractor host::
  ...
  user.user_permissions.add( Permission.objects.get( codename='view_network' ) )
  user.user_permissions.add( Permission.objects.get( codename='view_addressblock' ) )
  user.user_permissions.add( Permission.objects.get( codename='can_create_foundation' ) )
  user.user_permissions.add( Permission.objects.get( codename='delete_foundation' ) )
  user.user_permissions.add( Permission.objects.get( codename='add_structure' ) )
  user.user_permissions.add( Permission.objects.get( codename='delete_structure' ) )
  user.user_permissions.add( Permission.objects.get( codename='add_realnetworkinterface' ) )
  user.user_permissions.add( Permission.objects.get( codename='add_address' ) )
  user.user_permissions.add( Permission.objects.get( codename='can_create_foundation_job' ) )
  user.user_permissions.add( Permission.objects.get( codename='can_create_structure_job' ) )
  user.user_permissions.add( Permission.objects.get( codename='change_structure' ) )
  user.user_permissions.add( Permission.objects.get( codename='can_config_structure' ) )
  user.user_permissions.add( Permission.objects.get( codename='add_structurebox' ) )
  user.user_permissions.add( Permission.objects.get( codename='add_foundationbox' ) )
  user.user_permissions.add( Permission.objects.get( codename='view_structureblueprint' ) )
  user.user_permissions.add( Permission.objects.get( codename='view_complex' ) )
