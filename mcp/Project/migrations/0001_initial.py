    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('build_name', models.CharField(blank=True, max_length=540, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('release_branch', models.CharField(default='master', max_length=512)),
                ...
                ('last_checked', models.DateTimeField(default=datetime.datetime(1, 1, 1, 0, 0, tzinfo=datetime.timezone.utc))),
        ...
        migrations.AddField(
            model_name='build',
            name='site',
            field=models.ForeignKey(blank=True, help_text='Site to build on, if not specified will be built on any site that is flaged as generic', null=True, on_delete=django.db.models.deletion.PROTECT, to='Resource.site'),
        ),
